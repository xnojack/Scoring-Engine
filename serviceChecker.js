...
const uptime = JSON.parse(fs.readFileSync('uptime.json', 'utf8'));
...
module.exports = async function()
{
	for(let service in services)
	{
		...
		else if(services[service].type == "dns")
		{
			...
			let lastChecked = uptime[service].lastChecked>-1?uptime[service].lastChecked:-1
